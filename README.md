...
### Current Homepage (runtime capture)
> Placeholder kept so you can add your own runtime screenshot later without blocking branch updates.

> _Screenshot intentionally omitted from git to avoid binary-file update issues. Add your own image later at `public/images/readme/homepage-current.png`._
